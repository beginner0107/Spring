...
<script type="text/javascript">
	...
	function resultHtml(data){
   	...
   	html+="<th>번호</th>";
		...
		html+="</tr>";
		// 반복문 처리 { 0 },{ 1 }, { 2 }
		var sessionData = '${sessionScope.userId}';
		$.each(data, function(index, obj){
			  ...
			  html+="<td>"+obj.num+"</td>";
				...
				if(sessionData!=null && sessionData==obj.id){
					html+="<th><input type='button' value='삭제' onclick='deFn("+obj.num+")' class='btn btn-warning'></th>";
				}else{
					html+="<th><input type='button' value='삭제' onclick='deFn("+obj.num+")' class='btn btn-warning' disabled></th>";
				}
				html+="</tr>";	
		});
		html+="</table>";
...
<div class= "container">
	...
	<div class= "panel panel-default">
		<div class= "panel-heading">
		  ...
		  <form class="form-inline" action="${root }/memberLogin.do" method="post">
						  ...
						  <c:forEach var="vo" items="${list }">
						  		<tr>
						  		  ...
						  		  <th><input type="button" value="삭제" onclick="deleteFn(${vo.num})" class="btn btn-warning"></th>
						  		   ...
						  		   <c:if test="${sessionScope.userId!=vo.id }">
						  		  <th><input type="button" value="삭제" onclick="deleteFn(${vo.num})" class="btn btn-warning" disabled="disabled"></th>
						  		  </c:if>
						  		</tr>
						  </c:forEach>		
						  </c:if>
